...
jobs_args.add_argument("pay", type = int, help = "Enter the pay of the job (float)", required = True)
...
put_jobs_args.add_argument("pay", type = int, help = "Enter the pay of the job (float)", required = True)
